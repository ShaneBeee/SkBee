...
public class ExprTextDisplayBackgroundColor extends SimplePropertyExpression<Display, Color> {

    static {
        register(ExprTextDisplayBackgroundColor.class, Color.class,
                "text background color", "displayentities");
    }

    @SuppressWarnings("deprecation")
    @Override
    public @Nullable Color convert(Display display) {
        if (display instanceof TextDisplay textDisplay) return textDisplay.getBackgroundColor();
        return null;
    }
