...
public class ExprAsyncChatMessage extends SimpleExpression<ComponentWrapper> {
    ...
    public static void register(Registration reg) {
        reg.newSimpleExpression(ExprAsyncChatMessage.class, ComponentWrapper.class, "async chat (format|:message)")
            .name("TextComponent - Async Chat Format/Message")
            .description("Get/set the chat message from an async chat event as a text component.", "Set the chat format of an async chat event (no getter for this).", "Requires PaperMC!")
