...
@Description({"Apply an attribute modifier to an item.",
...
public class SecAttributeModifier extends Section {
    ...
    static {
        ...
        if (ItemUtils.HAS_EQUIPMENT_SLOT_GROUP) {
            ...
            VALIDATIOR.addEntryData(new ExpressionEntryData<>("slot", null, false, EquipmentSlot.class));
        }
    ...
    protected @Nullable TriggerItem walk(Event event) {
        ...
        Object slot = this.slot.getSingle(event);

        if (attribute == null || slot == null || amountNum == null || operation == null)
        ...
        if (ItemUtils.HAS_KEY) {
            ...
            if (slot instanceof EquipmentSlotGroup slotGroup) {
