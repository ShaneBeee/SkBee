...
import com.shanebeestudios.skbee.api.registration.EnumWrapper;
...
public class Types {
    ...
    public static void register(Registration reg) {
        if (Classes.getExactClassInfo(BossBar.class) == null) {
            reg.newType(BossBar.class, "bossbar")
                .user("boss ?bars?")
                .name("BossBar")
        ...
        if (Classes.getExactClassInfo(BarStyle.class) == null && Classes.getClassInfoNoError("bossbarstyle") == null) {
            ...
            reg.newEnumType(BarStyle.class, BAR_STYLE_ENUM, "bossbarstyle")
        ...
        if (Classes.getExactClassInfo(BarFlag.class) == null && Classes.getClassInfoNoError("bossbarflag") == null) {
            reg.newEnumType(BarFlag.class, "bossbarflag")
                .user("boss ?bar ?flags?")
                .name("BossBar Flag")
