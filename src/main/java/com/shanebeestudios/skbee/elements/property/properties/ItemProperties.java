...
public class ItemProperties {
    ...
    static {
        PropertyRegistry.registerItemProperty("fire resistant", new Property<>(ItemType.class, Boolean.class) {
                @Override
        ...
        if (Skript.classExists("org.bukkit.inventory.ItemRarity")) {
            ...
            PropertyRegistry.registerItemProperty("item rarity", new Property<>(ItemType.class, String.class) {
        ...
        PropertyRegistry.registerItemProperty("unbreakable", new Property<>(ItemType.class, Boolean.class) {
                @Override
                public Boolean get(ItemType itemType) {
